    ...
    <PlantillaLayout title={'EJC - Contact'} contentPage={'Page with information to contact us'}>
      <Box sx={{mt: {xs: 13, sm: 14, md: 15}, height: 'auto', position: 'relative'}}>
        <ContactHeader 
          ...
          contactLinkMessageWhatsapp={'https://wa.link/ajnanv'}
        />
      </Box>
      <Container sx={{py:5}}>
        <Grid container>
        ...
        <Grid container justifyContent="center" alignItems="center" spacing={5}>
          ...
          <Grid item xs={12}>
            <ContactDirect 
              ...
              contact1Position={'Web Development'}
              contact1Phone={'+593967454468'}
              contact1Email={'paspiazusabando@gmail.com'}
              contact1Link={'https://wa.link/ajnanv'}
      ...
      <Container sx={{py: 3, display: 'flex', justifyContent:'center', alignItems:'center'}}>
        <IconButton 
          color="secondary" 
          href="https://www.facebook.com/profile.php?id=100083073915723" 
          target="_blank"
        >
          <FacebookIcon 
